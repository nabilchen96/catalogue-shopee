        ...
        <div class="col-md-12 px-1">
            <div class="row">
                <div class="col-12 col-xl-8 mb-xl-0">
                    <h3 class="font-weight-bold">Data Pembelian </h3>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <p><i class="bi bi-grid"></i>
                                            <span>
                                                Total Pembelian: {{ @$item->jumlah_pembelian }} Item
                                            </span>
                                        </p>
                                        <br>
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <h4>Rp. {{ number_format(@$item->harga_beli_satuan * @$item->jumlah_pembelian) }}
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal-content">
                <form id="form">
                    <div class="modal-header p-3">
                        <h5 class="modal-title m-2" id="exampleModalLabel">Pembelian Form</h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_barang" id="id_barang" class="form-control form-control-sm" required>
                                ...
                                <?php $barang = DB::table('barangs')->get(); ?>
                        ...
                        <div class="form-group">
                            <label>Harga Satuan <sup class="text-danger">*</sup></label>
                            <input name="harga_beli_satuan" id="harga_beli_satuan" type="number" placeholder="Harga Beli Satuan"
                                class="form-control form-control-sm" required>
                        </div>

                        <div class="form-group">
                            <label>Jumlah Pembelian <sup class="text-danger">*</sup></label>
                            <input name="jumlah_pembelian" id="jumlah_pembelian" type="number" placeholder="Jumlah Pembelian"
                                class="form-control form-control-sm" required>
                        </div>                        
                        <div class="form-group">
                            <label>Tanggal Pembelian <sup class="text-danger">*</sup></label>
                            <input name="tanggal_pembelian" id="tanggal_pembelian" type="date" placeholder="Tanggal Pembelian"
                                class="form-control form-control-sm" required>
                        </div>
...
@push('script')
    <script>
        form.onsubmit = (e) => {
            ...
            axios({
                    method: 'post',
                    url: formData.get('id') == '' ? '/store-pembelian' : '/update-pembelian',
                    data: formData,
                })
                .then(function(res) {
                    //handle success         
        ...
        $('#modal').on('show.bs.modal', function(event) {
            ...
            if (recipient) {
                ...
                modal.find('#tanggal_pembelian').val(recipient.tanggal_pembelian);
                modal.find('#harga_beli_satuan').val(recipient.harga_beli_satuan);
                modal.find('#jumlah_pembelian').val(recipient.jumlah_pembelian);
