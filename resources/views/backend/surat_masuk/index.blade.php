        ...
        <div class="col-md-12 px-1">
            <div class="row">
                <div class="col-12 col-xl-8 mb-xl-0">
                    <h3 class="font-weight-bold">Data Surat Masuk</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <form id="form">
                    <div class="modal-header p-3">
                        <h5 class="modal-title m-2" id="exampleModalLabel">Surat Masuk Form</h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Alamat Pengirim <sup class="text-danger">*</sup></label>
                            <input name="alamat_pengirim" type="text" id="alamat_pengirim"
                                placeholder="Alamat Pengirim" class="form-control form-control-sm" required>
                        </div>
                        <div class="form-group">
...
@push('script')
    <script>
        form.onsubmit = (e) => {
            ...
            axios({
                    method: 'post',
                    url: formData.get('id') == '' ? '/store-surat-masuk' : '/update-surat-masuk',
                    data: formData,
                })
                .then(function(res) {
                    //handle success         
        ...
        $('#modal').on('show.bs.modal', function(event) {
            ...
            if (recipient) {
                ...
                modal.find('#alamat_pengirim').val(recipient.alamat_pengirim);
