        ...
        <div class="col-md-12 px-1">
            <div class="row">
                <div class="col-12 col-xl-8 mb-xl-0">
                    <h3 class="font-weight-bold">Data Inventaris</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12 px-1">
                <div class="input-group shadow mb-3 mt-3">
                    ...
                    <button type="submit" style="border-top-left-radius: 0; border-bottom-left-radius: 0; border: none; height: 38px;" class="input-group-text bg-primary text-white"
                        id="basic-addon2">
            ...
            <div class="col-lg-3 col-6 px-1">
                <div class="card shadow mb-4">
                    <div style="
                        ...
                        @if($item->foto)
                            background-image: url('{{ asset('foto') }}/{{ $item->foto }}') 
                        @else
                    ...
                    <div class="card-body p-3">
                        <p class="judul_berita mt-0 mb-3">{{ $item->nama_barang }} - Kode: {{ $item->kode_inventaris }}</p>
                        <span class="badge bg-primary text-white" style="border-radius: 8px;">{{ $item->jumlah }}</span>
            ...
            <div class="modal-content">
                <form id="form">
                    <div class="modal-header p-3">
                        <h5 class="modal-title m-2" id="exampleModalLabel">Inventaris Form</h5>
                    </div>
                    <div class="modal-body">
                        <input type="hidden" name="id" id="id">
                        <div class="form-group">
                            <label>Kode Inventaris <sup class="text-danger">*</sup></label>
                            <input name="kode_inventaris" id="kode_inventaris" type="text" placeholder="Kode Inventaris"
                        ...
                        <div class="form-group">
                            ...
                            <input name="tempat" id="tempat" type="text" placeholder="tempat"
                                class="form-control form-control-sm" required>
                        </div>
                        <div class="form-group">
                            <label>Foto</label>
...
@push('script')
    <script>
        form.onsubmit = (e) => {
            ...
            axios({
                    method: 'post',
                    url: formData.get('id') == '' ? '/store-inventaris' : '/update-inventaris',
                    data: formData,
                })
                .then(function(res) {
                    //handle success         
        ...
        $('#modal').on('show.bs.modal', function(event) {
            ...
            if (recipient) {
                ...
                modal.find('#kode_inventaris').val(recipient.kode_inventaris);
                modal.find('#nama_barang').val(recipient.nama_barang);
                modal.find('#jumlah').val(recipient.jumlah);
